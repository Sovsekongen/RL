...
fileUCB8 = fopen('C:/Users/vikpo/desktop/ucbc8.txt', 'r');
fileUCB4 = fopen('C:/Users/vikpo/desktop/ucbc4.txt', 'r');
fileUCB2 = fopen('C:/Users/vikpo/desktop/ucbc2.txt', 'r');
fileUCB1 = fopen('C:/Users/vikpo/desktop/ucbc1.txt', 'r');
...
xlabel('Iterations');
ylabel('Avg');
legend({'c = 8','c = 4', 'c = 2', 'c = 1'}, 'location', 'southeast');
